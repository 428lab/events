const ja = {
  ...
  retry: "同じ保存を確認／再試行", open: "編集を開く", success: "保存しました。画像枠を選んで「画像を差し替え」できます。編集保存の成功後に発表してください。", restart: "別デッキとして取り込む", restartConfirm: "前の保存結果を確認しましたか？既存のスライドは変更せず、別の取り込みを明示的に開始します。",

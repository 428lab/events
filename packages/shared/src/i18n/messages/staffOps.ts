...
const ja = {
  ...
  preSurveyAccessNote:
    "共有URLが表示された回数です。日ごとの件数だけを記録し、個人を特定する情報は保存していません。",
  preSurveyAccessDay: "日付",
  preSurveyAccessViews: "表示",
...
const en: Record<keyof typeof ja, string> = {
  ...
  preSurveyAccessNote:
    "How many times the share URL was viewed. Only daily counts are stored; nothing that could identify a person.",
  preSurveyAccessDay: "Date",
  preSurveyAccessViews: "Views",

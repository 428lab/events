...
const ja = {
  ...
  meetPrizeConditionBingo: "ビンゴ景品（達成した人が1つ選べる）",
  ...
  /** 申込が1件でも押せるので、英語は単数用のキーを分ける (#363) */
  ...
  imageBgDark: "ダーク",
  imageBgFireworks: "花火",
  imageBgFireworksWarm: "花火（暖色）",
  imageBgFireworksCool: "花火（寒色）",
  imageBgAerialShells: "打ち上げ花火",
  imageBgConfetti: "紙吹雪",
  imageBgStars: "星空",
  imageBgTeal: "ティール",
  imageBgAmber: "アンバー",
...
const en: Record<keyof typeof ja, string> = {
  ...
  meetPrizeConditionBingo: "Bingo prize (achievers pick one)",
  ...
  slotConfirmedCapacity: "Confirmed {{n}} / {{total}}",
  ...
  imageBgFireworksCool: "Fireworks (cool)",
  imageBgAerialShells: "Aerial shells",
  imageBgConfetti: "Confetti",
  imageBgStars: "Starry sky",
  imageBgTeal: "Teal",
  imageBgAmber: "Amber",
  imageBgLight: "Light",
  imageBgDots: "Dots",

...
const ja = {
  ...
  pollLead: "候補日ごとに ○（参加）/△（未定）/×（不可）で回答してください。確定日に○・△の人は、登録条件を満たせば自動参加登録されます。匿名回答でも登録後の名前は参加者一覧に表示されます。",
  autoJoinResults: "日程確定時の参加登録結果",
  autoJoinSnapshot: "確定時点の記録です。その後の取消・繰り上げは参加者一覧で確認してください。追加操作が必要な方には本人へ通知しています。",
  autoJoin_registered: "自動登録",
  autoJoin_existing: "既存の登録を維持",
  autoJoin_action_required: "本人の操作・確認が必要",
  autoJoinStatus_confirmed: "参加確定",
  autoJoinStatus_waitlist: "キャンセル待ち",
  autoJoinStatus_applied: "抽選申込（参加未確定）",
  autoJoinStatus_lost: "落選",
  autoJoinStatus_canceled: "取消済み",
  ...
  autoJoinFailed: "確定結果を取得できませんでした。再読み込みして確認してください。",
  autoJoinClose: "閉じる",
  ...
  decidedChip: "この日程に決定",
  decide: "この日程に決定",
  decideConfirm: "この日程に決定し、○・△の回答者を参加登録しますか？定員・抽選・必須アンケートなどの条件は維持します。複数の参加枠がある場合は本人による選択が必要です。先着枠は回答順に登録します。",
  topChip: "参加最多",
  deleteOption: "候補を削除",
...
const en: Record<keyof typeof ja, string> = {
  ...
  pollLead:
    "Answer Yes, Maybe, or No for each date. Yes/Maybe respondents on the chosen date are automatically registered if eligible. Even with anonymous voting, registered names appear in the participant list.",
  autoJoinResults: "Registration results at date confirmation",
  autoJoinSnapshot: "A snapshot at confirmation. Check the participant list for later cancellations or promotions. People needing further action have been notified.",
  autoJoin_registered: "Automatically registered",
  autoJoin_existing: "Existing registration retained",
  autoJoin_action_required: "Action or confirmation needed",
  autoJoinStatus_confirmed: "Confirmed participant",
  autoJoinStatus_waitlist: "Waitlisted",
  autoJoinStatus_applied: "Lottery application (not confirmed)",
  autoJoinStatus_lost: "Not selected",
  autoJoinStatus_canceled: "Canceled",
  ...
  autoJoinFailed: "Could not retrieve confirmation results. Reload to check the current state.",
  autoJoinClose: "Close",
  ...
  decideConfirm: "Confirm this date and register Yes/Maybe respondents? Capacity, lottery and required-survey rules still apply. With multiple slots, people must choose a slot themselves. First-come slots follow response order.",

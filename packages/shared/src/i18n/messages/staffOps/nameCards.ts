...
const ja = {
  ...
  nameCardSelectAll: "全員を選択",
  nameCardClearAll: "全員の選択を解除",
  nameCardPrint: "印刷する",
  nameCardBuilding: "カードを作成しています（{{done}} / {{total}}）",
  nameCardPeopleHeading: "印刷する人",
  nameCardPrintCheckbox: "{{name}} を印刷する",
  nameCardSearch: "名前・ハンドルを検索",
  nameCardAllRoles: "すべての役割",
  nameCardAllSlots: "すべての参加枠",
  nameCardNoSlot: "参加枠なし",
  nameCardSelectFilteredOnly: "絞り込み結果だけ選択",
  nameCardNoMatches: "条件に一致する人がいません。",
  nameCardListRange: "{{total}}人中 {{from}}〜{{to}}人を表示",
  nameCardPage: "{{page}}ページ目",
  nameCardNextPage: "次のページ",
  nameCardPreviousPage: "前のページ",
  nameCardSelectionHint: "検索・ページ切り替えでは印刷対象は変わりません。表示されていない人も、選択済みなら印刷されます。",
  nameCardCutGuides: "裁断ガイドと白余白を付ける",
  nameCardCutGuidesHint: "仕上がり91×55mm・A4に10面。内側に最低1mmの白余白を設け、絵柄を縦横比を保って縮小します。カード間は2mmです。名刺台紙ではOFFにしてください。",
...
const en: Record<keyof typeof ja, string> = {
  ...
  nameCardSearch: "Search name or handle",
  nameCardAllRoles: "All roles",
  nameCardAllSlots: "All registration slots",
  nameCardNoSlot: "No registration slot",
  nameCardSelectFilteredOnly: "Select only matching people",
  nameCardNoMatches: "No people match these filters.",
  nameCardListRange: "Showing {{from}}–{{to}} of {{total}}",
  nameCardPage: "Page {{page}}",
  nameCardNextPage: "Next page",
  nameCardPreviousPage: "Previous page",
  nameCardSelectionHint: "Searching or changing pages does not change the print selection. Selected people on other pages will also be printed.",
  nameCardCutGuides: "Add cutting guides and white margins",
  nameCardCutGuidesHint: "91 × 55 mm finished size, ten per A4 sheet. Artwork is scaled proportionally to leave at least 1 mm of white margin inside, with 2 mm between cards. Turn off for pre-cut card stock.",

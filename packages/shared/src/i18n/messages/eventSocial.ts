...
const ja = {
  ...
  /** 上限は固定の定数（200枚・100件）なので英語の単数用キーは要らない */
  ...
  photosPagination: "写真・動画のページ切り替え",
  photosPrevious: "前へ",
  photosNext: "次へ",
  photosPage: "{{page}} / {{pages}} ページ（新しい順）",
  ...
  bingoSectionTitle: "ビンゴ会場",
  bingoStatusSetup: "受付中",
  bingoStatusRunning: "抽選中",
  bingoStatusEnded: "終了",
  bingoControlLink: "抽選を操作する",
...
const en: Record<keyof typeof ja, string> = {
  ...
  photosPagination: "Photo and video pages",
  photosPrevious: "Previous",
  photosNext: "Next",
  photosPage: "Page {{page}} of {{pages}} (newest first)",
  ...
  bingoSectionTitle: "Bingo",
  bingoStatusSetup: "Registration open",
  bingoStatusRunning: "Drawing numbers",
  bingoStatusEnded: "Ended",
  bingoControlLink: "Run the draw",

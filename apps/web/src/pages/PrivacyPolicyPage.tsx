  ...
  return (
    <Stack spacing={3} sx={{ maxWidth: 760 }}>
      ...
      <Section n={7} title="退会・データの削除">
        参加解除やイベント削除（主催者）で関連データを削除できます。アカウント設定から退会でき、退会すると参加履歴・いいね・コメント・ログイン情報は削除されます（主催したイベント・コミュニティ・会場は、参加者の記録を保つため「退会済みユーザー」名義で残ります）。保有データの開示・訂正・削除をご希望の場合は、お問い合わせフォームよりご連絡ください。
      </Section>

      <Section n={8} title="運用記録（監査ログ）">
        アカウントの統合・退会・ログイン方法の引き継ぎなど、後から取り消せない操作については、不正利用や不具合の調査のためユーザーIDとユーザー名（ハンドル）・操作日時を記録し、1年間保持したのち自動的に削除します。メールアドレス・連絡先・投稿本文は記録しません。
      </Section>
      ...
      <Typography variant="body2" color="text.secondary">
        制定日: 2026年6月26日 ・ 最終更新日: 2026年8月4日
      </Typography>
    </Stack>
  );
}
